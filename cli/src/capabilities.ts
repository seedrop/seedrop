...
export const MCP_CLI_COVERAGE: CliCommandCoverage[] = [
  ...
  { command: "seed view brief", status: "covered", tools: ["seedrop_view_brief"], reason: "View brief is exposed directly." },
  { command: "seed view claim", status: "covered", tools: ["seedrop_signal_claim"], reason: "Claim signals are exposed directly." },
  ...
  { command: "seed view lock", status: "covered", tools: ["seedrop_signal_lock"], reason: "Lock signals are exposed directly." },
