...
export const MCP_CLI_COVERAGE: CliCommandCoverage[] = [
  ...
  { command: "seed continuity ack", status: "covered", tools: ["seedrop_continuity_ack"], reason: "Explicitly commits a previously returned immutable continuity page with retry-safe watermark and presence semantics." },
  ...
  { command: "seed space outbox", status: "covered", tools: ["seedrop_space_outbox"], reason: "Agents can inspect pending and dead-letter post effects." },
  { command: "seed space outbox-retry", status: "covered", tools: ["seedrop_space_outbox_retry"], reason: "Agents can explicitly repair a pending or dead-letter post command." },
  ...
  { command: "seed space post", status: "covered", tools: ["seedrop_space_post"], reason: "Space post is wrapped with role, stable request id, and explicit url/passport support." },
  ...
  { command: "seed view graves", status: "covered", tools: ["seedrop_view_graves"], reason: "Dead runs with their cause of death, scopable to paths in play; the negative knowledge git cannot supply." },
  { command: "seed run sweep", status: "covered", tools: ["seedrop_run_sweep"], reason: "Sweeps abandoned in_progress runs into the graveyard with an inferred cause of death." },
