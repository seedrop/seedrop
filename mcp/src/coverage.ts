...
export const MCP_CLI_COVERAGE: CliCommandCoverage[] = [
  ...
  { command: "seed", status: "covered", tools: ["seedrop_boot"], reason: "Bare seed now renders the stateless-agent boot report, and MCP exposes that report directly." },
  { command: "seed boot", status: "covered", tools: ["seedrop_boot"], reason: "Boot is wrapped with JSON, messages, passport/url, peek, and since options." },
